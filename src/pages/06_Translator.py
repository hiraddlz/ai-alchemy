...
def main():
    ...
    st.write("Enter text and select a target language to translate using OpenAI's GPT model.")
    ...
    target_language = st.selectbox("Select target language", [
        "Persian", "English", "Spanish", "French", "German", "Chinese", "Japanese", "Hindi", "Arabic", "Russian", "Portuguese"
    ])
